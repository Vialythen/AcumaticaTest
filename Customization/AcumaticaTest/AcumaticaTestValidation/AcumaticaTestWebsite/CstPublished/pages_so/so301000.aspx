...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Order Summary"
        ...
        <Template>
            ...
            <px:PXCheckBox ID="chkDontApprove" runat="server" DataField="DontApprove" Enabled="False" ></px:PXCheckBox>
            <px:PXCheckBox ID="chkApproved" runat="server" DataField="Approved" CommitChanges="True" Enabled="False" ></px:PXCheckBox>
            ...
            <px:PXTextEdit Size="s" ID="edCustomerOrderNbr" runat="server" DataField="CustomerOrderNbr" CommitChanges="True" ></px:PXTextEdit>
            ...
            <px:PXSegmentMask CommitChanges="True" ID="edCustomerID" runat="server" DataField="CustomerID" AllowAddNew="True"
                AllowEdit="True" DataSourceID="ds" ></px:PXSegmentMask>
            <px:PXSegmentMask CommitChanges="True" ID="edCustomerLocationID" runat="server" AutoRefresh="True"
                DataField="CustomerLocationID" DataSourceID="ds" ></px:PXSegmentMask>
            ...
            <px:PXTextEdit IsClientControl="true" ID="edOrderDesc" runat="server" DataField="OrderDesc" ></px:PXTextEdit>
            ...
            <px:PXCheckBox runat="server" DataField="IsRUTROTDeductible" CommitChanges="True" ID="chkRUTROT" AlignLeft="true" ></px:PXCheckBox>
	...
	<px:PXCheckBox runat="server" ID="CstPXCheckBox2" DataField="UsrImportant" /></Template>
    </px:PXFormView>
</asp:Content>
