...
namespace PX.Objects.WZ
{
    ...
    public class WZScenarioEntry : PXGraph<WZScenarioEntry, WZScenario>
    {
        ...
        public readonly PXFieldScreenToSiteMapAddHelper<WZScenario> ScreenToSiteMapAddHelper;

        public WZScenarioEntry()
        {
            ScreenToSiteMapAddHelper = new PXScenarioToSiteMapAddHelper(this,
                "WZ", "~/Pages/WZ/WZ201505.aspx", typeof(WZScenario.name), typeof(WZScenario.name), typeof(WZScenario.nodeID), null,
                new[] { new PXFieldScreenToSiteMapAddHelper<WZScenario>.Field<WZScenario.scenarioID>("ScenarioID") });
        }
