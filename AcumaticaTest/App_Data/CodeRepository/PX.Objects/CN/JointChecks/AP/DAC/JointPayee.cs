...
namespace PX.Objects.CN.JointChecks.AP.DAC
{
	...
	public class JointPayee : BaseCache, IBqlTable
	{
		...
		[PXDBDecimal]
		[PXDefault]
		[PXUIVerify(typeof(Where<jointAmountOwed, Greater<decimal0>>), PXErrorLevel.Error,
			JointCheckMessages.TheValueMustBeGreaterThanZero,
			CheckOnInserted = false, CheckOnRowSelected = false, CheckOnVerify = false)]
		...
		[PXUIField(DisplayName = JointCheckLabels.BillLineNumber, Visibility = PXUIVisibility.Invisible)]
